...
{
    public class ScraperGeorgia : ScraperQpublic
    {
        private readonly string _county;

        public ScraperGeorgia(string county, string countyCode, string searchUrl,
            string submitUrl = "http://qpublic7.qpublic.net/ga_alsearch.php",
            string xpathLinkNodes = "//table[@class='table_class']//tr[3]",
            string baseUrl = "http://qpublic7.qpublic.net/")
        {
            _county = county;
