...
{
    public class ScraperGeorgetown : ScraperQpublic
    {
        public ScraperGeorgetown()
        {
            CountyCode = "sc_georgetown";
            SearchUrl = "http://qpublic5.qpublic.net/fl_search.php?county=sc_georgetown&searchType=parcel";
        ...
        {
            return county == "South Carolina:Georgetown";
        }

        public override Scraper GetClone()
        {
            return new ScraperGeorgetown();
        }
